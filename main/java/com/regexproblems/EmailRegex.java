...
public class EmailRegex {
    ...
    public static void main(String[] args) {
        ...
        String email7 = "abc@bridgelabz.co.us"; // Invalid (more than 2 characters)
        String email8 = "abc@bridgelabz.co.in"; // Valid
        ...
        System.out.println(email7 + " is " + (validateEmail(email7) ? "valid" : "invalid") + " email.");
        System.out.println(email8 + " is " + (validateEmail(email8) ? "valid" : "invalid") + " email.");
    }
}
